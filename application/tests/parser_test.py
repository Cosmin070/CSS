...
class ParserTest(unittest.TestCase):
    ...
    def test_get_symbols_position(self):
        open_bracket_positions, close_bracket_positions = get_symbols_position(
    ...
    def test_get_variables_and_values(self):
        self.assertDictEqual({'a': '5', 'b': '0', 'expression': 'a+b'}, get_variables_and_values(
            '<equation><expression>a+b</expression><a>4</a><a>5</a><b>0</b></equation>'))
